  ...
  return (
    <div className="hero-container">
     ...
     <div className="content-width">
           <header>
          Find The Place To Live <span className="your-dreams">Your Dreams</span> Easily Here
        </header>
...
<div className="search-section">
    <button>Search <AiOutlineRight/> </button>
    <input type="text" placeholder="Search for apartments in your desired location" />
</div>
